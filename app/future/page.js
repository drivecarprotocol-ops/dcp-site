    ...
    <div className="min-h-screen bg-black text-white selection:bg-blue-500/25 selection:text-white">
      <section className="relative isolate overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 md:px-8 md:py-28">
          ...
          >
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-sm uppercase tracking-[0.22em] text-white/55 transition hover:text-white"
            >
      ...
      <section className="border-y border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-6 py-18 md:px-8 md:py-22">
          <div className="max-w-4xl rounded-[2rem] border border-blue-500/20 bg-blue-500/[0.06] p-8">
      ...
      <section className="mx-auto max-w-7xl px-6 py-18 md:px-8 md:py-22">
        ...
        <div className="mt-10 rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/[0.05] to-white/[0.02] p-8">
          <p className="max-w-4xl text-lg leading-8 text-white/76">
