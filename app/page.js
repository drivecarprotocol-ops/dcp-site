            ...
            <div className="relative inline-block">
              <div className="relative">
                ...
                <img
                  ...
                  alt=""
                  className="pointer-events-none absolute left-[90%] top-[10px] z-20 w-16 opacity-95 md:left-[95%] md:top-[14px] md:w-20"
                />
              </div>

              <div className="relative mt-2">
                <div className="relative z-10 pl-0 text-lg uppercase tracking-[0.34em] text-white/82 md:text-2.15xl">
                  PROTOCOL
                </div>
                ...
                <img
                  ...
                  alt=""
                  className="pointer-events-none absolute left-[44%] top-[-10px] z-0 w-56 opacity-95 md:left-[46%] md:top-[-14px] md:w-72"
                />
              </div>
            </div>
